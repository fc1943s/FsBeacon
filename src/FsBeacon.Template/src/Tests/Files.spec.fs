        ...
        (fun () ->
            ...
            it
                ...
                (fun () ->
                    ...
                    let _old1 () =
                        Cy2.waitForRegex
                            """"<0> # Primitives.registerAtom FsStore/logLevel atom4 AtomWithStorage": "1","""

                        Cy2.waitForRegex
                            """"<1> # Primitives.registerAtom FsStore/showDebug atom7 AtomWithStorage": "1","""

                        Cy2.waitForRegex
                            """"<2> # Primitives.registerAtom FsStore/gunOptions atom10 AtomWithStorage": "1","""

                        Cy2.waitForRegex
                            """"<3> # Primitives.registerAtom FsStore/hubUrl atom13 AtomWithStorage": "1","""
                        ...
                        Cy2.waitForRegex
                            """"<11> # Primitives.registerAtom FsStore/sessionRestored atom17 Atom": "1","""

                        Cy2.waitForRegex
                            """"<12> # Primitives.registerAtom FsUi/darkMode atom36 AtomWithStorage": "1","""
                        ...
                        Cy2.waitForRegex
                            """"<15> # Primitives.registerAtom FsUi/fontSize atom43 AtomWithStorage": "1","""
                        ...
                        Cy2.waitForRegex
                            """"<19> # Primitives.registerAtom FsUi/systemUiFont atom51 AtomWithSync": "1","""
                        ...
                        Cy2.waitForRegex
                            """"<22> # Primitives.registerAtom FsBeacon/syncHydrateStarted atom55 Atom": "1","""
